 ...
 * Generated at: 2017-10-09 06:15:13 UTC
     ...
     for(int j=0; j < mainFolders.length;j++)
          ...
          if(errorMsg=="")
               {
                  ...
                  String prodResTimeWithExtension="";String prodResTime="";String pathProductResTime="";String pathProductResTimeChangeSlash = "";
      ...
      out.write("         ");
         ...
         while ((line = bufferedReader.readLine()) != null) {
                ...
                {
                    String bold       = "<td style='font-weight:500;'>";
                    dataInLine        = line.split(",");
                    String label      = bold + dataInLine[0];
                    String sample     = bold + dataInLine[1];
                    String avg        = bold + Float.parseFloat(dataInLine[2])/1000;
                    String median     = bold + Float.parseFloat(dataInLine[3])/1000;
                    String ninetyline = bold + Float.parseFloat(dataInLine[4])/1000;
                    String min        = bold + Float.parseFloat(dataInLine[5])/1000;
                    String max        = bold + Float.parseFloat(dataInLine[6])/1000;
                    String error      = bold + dataInLine[7];
                    String throughput = bold + dataInLine[8];
                    String kbpersec   = bold + dataInLine[9];

                    String errorString=dataInLine[7].replace("%","");
                    if(Float.parseFloat(errorString)>=2.0)
                       errorString = "<td style='color:red;font-weight:600;'>"+errorString+"%";
                    String avgString="";
                    if((Float.parseFloat(dataInLine[2])/1000)>=3.0)
                       avgString = "<td style='color:red;font-weight:600;'>"+Float.parseFloat(dataInLine[2])/1000;
      ...
      out.write("                       ");
                    ...
                    String notBold    = "<td>";
                    dataInLine        = line.split(",");
                    String label      = notBold + dataInLine[0];
                    String sample     = notBold + dataInLine[1];
                    String avg        = notBold + Float.parseFloat(dataInLine[2])/1000;
                    String median     = notBold + Float.parseFloat(dataInLine[3])/1000;
                    String ninetyline = notBold + Float.parseFloat(dataInLine[4])/1000;
                    String min        = notBold + Float.parseFloat(dataInLine[5])/1000;
                    String max        = notBold + Float.parseFloat(dataInLine[6])/1000;
                    String error      = notBold + dataInLine[7];
                    String throughput = notBold + dataInLine[8];
                    String kbpersec   = notBold + dataInLine[9];
      ...
      out.write("\" class=\"img-fluid\" style=\"width:100%;\" alt=\"");
      out.print(prodResTime);
